...
/** Una sola vez: adapta % guardados tras rotar el SVG de Lighthouse 90° a la izquierda. */
export const LIGHTHOUSE_MAP_ROTATION_FLAG = 'efg-map-rot:lighthouse:ccw90';

const MAP_KEY = 'lighthouse';
...
export function migrateLighthouseLocalMarkers(): void {
  try {
    if (localStorage.getItem(LIGHTHOUSE_MAP_ROTATION_FLAG) === '1') return;
    ...
    localStorage.setItem(LIGHTHOUSE_MAP_ROTATION_FLAG, '1');
  } catch {
